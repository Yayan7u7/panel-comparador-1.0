...
try {
    ...
    if (!empty($compare_user)) {
        // Usamos getMentionsByAuthorAndKeyword para obtener las menciones del usuario ($compare_user)
        // DENTRO del proyecto de Felifer.
        // Se mantiene la llamada a getMentionsByAuthorAndKeyword como la tenías, sin límites extra aquí si la función por defecto ya es 500.
        // Si quieres que aquí también haya un límite de 100, la llamada debería ser:
        // getMentionsByAuthorAndKeyword(BRANDMENTION_PROJECT_ID, $compare_user, $start_period, $end_period, $sources_for_comparison_api, 100, 100);
        $mentions_by_compare_user_to_felifer = getMentionsByAuthorAndKeyword(BRANDMENTION_PROJECT_ID, $compare_user, $start_period, $end_period, $sources_for_comparison_api);
...
<!-- El HTML generado por compare.php para ser inyectado en el index.php -->
<div class="comparison-result">
    ...
    <div class="row mt-4">
        <div class="col-md-6">
            <div class="card shadow"> <!-- Añadido shadow para el estilo -->
...
<!-- Script de Chart.js para la gráfica de pastel de comparación -->
<!-- NOTA: Este script se ejecutará cuando sea inyectado por el AJAX del index.php -->
<script>
